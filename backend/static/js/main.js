...
import { initLanguageSwitcher } from "./modules/language-switcher.js?v=3";
...
import { initCountryFilter } from "./modules/country-filter.js?v=4";
import { initAddUniversity } from "./modules/add-university.js?v=2";
import { initFAQ } from "./modules/faq.js?v=2";
import { initSlider } from "./modules/slider-mobile.js?v=6";
